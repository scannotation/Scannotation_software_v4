...
## Tutorial
To launch the **Library and Screening processes**, please read our [tutorial](https://github.com/scannotation/Scannotation_software/blob/master/Scannotation-tutorial.docx).
> **Note:** The tutorial was created for Scannotation version 3.7, but the main usage remains the same for the current version (which includes additional new features).
